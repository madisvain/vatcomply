...
class RootTest(TestCase):
    def test_root_endpoint(self):
        ...
        self.assertEqual(
            data["description"],
            "VAT validation API, geolocation tools, and ECB exchange rates"
        )
        self.assertEqual(data["documentation"], "https://api.vatcomply.com/docs")
        ...
        for endpoint in expected_endpoints:
            ...
            self.assertEqual(
                ...
                urljoin(settings.BASE_URL, endpoint)
            )